    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-100">
          <img
            src={heroImage}
            alt="StudyPoint platform preview on a desktop computer"
            ...
            {[
              {
                ...
                desc: "Courses designed by experts to keep you on track and progressing efficiently.",
              },
              {
                icon: "🌍",
                title: "Learn Anywhere",
                desc: "Access all your courses and materials from any device, at any time.",
              },
              {
                icon: "🏆",
                title: "Proven Results",
                desc: "Thousands of students have improved their grades and confidence with StudyPoint.",
              },
            ].map((f) => (
              <div
                key={f.title}
      ...
      <section className="py-16 text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="text-gray-500 mb-8">
            Join StudyPoint and unlock a world of high-quality courses, flexible scheduling, and expert guidance.
          </p>
          <Link
            href="/"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg transition-colors shadow"
          >
            Get Started
          </Link>
        </div>
