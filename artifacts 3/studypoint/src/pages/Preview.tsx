    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
          <img
            src={previewImage}
            alt="StudyPoint platform interface preview"
      ...
      <section className="py-16 text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="text-gray-500 mb-8">
            Sign up for free and get instant access to our full course library.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              href="/"
              className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3 rounded-lg transition-colors shadow"
            >
              Get Started Free
            </Link>
            <Link
